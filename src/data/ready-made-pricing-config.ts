...
export const READY_MADE_PRODUCT_OPTIONS: ReadyMadeProductOption[] = [
  {
    ...
    mainThumbnail: `${clothingTemplatesBase}/tshirt-gray.png.png`,
    defaultColor: "그레이",
  ...
  },
  {
    ...
    mainThumbnail: `${clothingTemplatesBase}/polp-gray.png.png`,
    defaultColor: "그레이",
    colors: READY_MADE_COLOR_OPTIONS,
  },
  {
  ...
  },
  {
    ...
    imageFront: `${readyMadeUploadsBase}/placeholder.png`,
    imageBack: `${readyMadeUploadsBase}/placeholder.png`,
    mainThumbnail: `${clothingTemplatesBase}/ziphoodie-gray.png.png`,
    defaultColor: "그레이",
    colors: READY_MADE_COLOR_OPTIONS,
  },
];
