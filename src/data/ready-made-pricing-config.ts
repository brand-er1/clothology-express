...
export const READY_MADE_PRODUCT_OPTIONS: ReadyMadeProductOption[] = [
  {
    ...
    mainThumbnail: `${clothingTemplatesBase}/separate/tshirt-gray-front.webp`,
    defaultColor: "그레이",
  ...
  },
  {
    ...
    mainThumbnail: `${clothingTemplatesBase}/separate/polo-gray-front.webp`,
    defaultColor: "그레이",
    colors: READY_MADE_COLOR_OPTIONS,
  },
  {
    ...
    mainThumbnail: `${clothingTemplatesBase}/sweatshirt-gray.png.png`,
    defaultColor: "그레이",
    colors: READY_MADE_COLOR_OPTIONS,
  },
  {
    ...
    imageFront: `${readyMadeUploadsBase}/placeholder.png`,
    imageBack: `${readyMadeUploadsBase}/placeholder.png`,
    mainThumbnail: `${clothingTemplatesBase}/shorts-gray.png.png`,
    defaultColor: "그레이",
    colors: READY_MADE_COLOR_OPTIONS,
  },
  {
    ...
    mainThumbnail: `${clothingTemplatesBase}/hoodie-gray.png.png`,
    defaultColor: "그레이",
    colors: READY_MADE_COLOR_OPTIONS,
  },
  {
    ...
    imageFront: `${readyMadeUploadsBase}/placeholder.png`,
    imageBack: `${readyMadeUploadsBase}/placeholder.png`,
    mainThumbnail: `${clothingTemplatesBase}/separate/ziphoodie-gray-front.webp`,
    defaultColor: "그레이",
    colors: READY_MADE_COLOR_OPTIONS,
  },
];
